...
import coffeecoin.main.CopyOfTools;
import coffeecoin.network.TxAction;

public class KeypairTest {

	public static void main(String[] args) throws Exception {
		String[] keypair = CopyOfTools.generateKeypair();
		String pubkey = keypair[0];
		String privkey = keypair[1];
		System.out.println("pubkey: " + pubkey);
		System.out.println("privkey: " + privkey);
		
		TxAction tx = new TxAction("RYoLxZA3zWQHDPJY951dBWwTActfAZbnEq1rncTG5EcB", 100, 
				...
				1403964829546L, 4);
		String sig = CopyOfTools.signTransaction(tx, "3041020100301306072A8648CE3D020106082A8648CE3D0301070427302502010104206378F17367A1C3CAE94613691E5638EAD81D9DE7BEBF46970B7FD4423B86EAAB");
		tx.setSignature(sig);
		...
		System.out.println(CopyOfTools.verifyTransaction(tx));
	}
}
